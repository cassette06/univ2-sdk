...
describe('Route', () => {
  ...
  const weth = WETH9[1]
  const pair_0_1 = new Pair(CurrencyAmount.fromRawAmount(token0, '100'), CurrencyAmount.fromRawAmount(token1, '200'), FACTORY_ADDRESS, INIT_CODE_HASH)
  const pair_0_weth = new Pair(CurrencyAmount.fromRawAmount(token0, '100'), CurrencyAmount.fromRawAmount(weth, '100'), FACTORY_ADDRESS, INIT_CODE_HASH)
  const pair_1_weth = new Pair(CurrencyAmount.fromRawAmount(token1, '175'), CurrencyAmount.fromRawAmount(weth, '100'), FACTORY_ADDRESS, INIT_CODE_HASH)
