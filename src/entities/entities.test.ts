      ...
      it('Pair', () => {
        pairs = [
          new Pair(
            ...
            CurrencyAmount.fromRawAmount(tokens[1], decimalize(1, tokens[1].decimals)),FACTORY_ADDRESS, INIT_CODE_HASH
          ),
          new Pair(
            CurrencyAmount.fromRawAmount(tokens[1], decimalize(1, tokens[1].decimals)),
            CurrencyAmount.fromRawAmount(tokens[2], decimalize(1, tokens[2].decimals)), FACTORY_ADDRESS, INIT_CODE_HASH
          ),
          new Pair(
            CurrencyAmount.fromRawAmount(tokens[2], decimalize(1, tokens[2].decimals)),
            CurrencyAmount.fromRawAmount(WETH9, decimalize(1234, WETH9.decimals)), FACTORY_ADDRESS, INIT_CODE_HASH
          )
        ]
      })
          ...
          route = new Route(
            [
              new Pair(
                ...
                CurrencyAmount.fromRawAmount(WETH9, decimalize(10, WETH9.decimals)), FACTORY_ADDRESS, INIT_CODE_HASH
              )
            ],
            tokens[1],
            WETH9
